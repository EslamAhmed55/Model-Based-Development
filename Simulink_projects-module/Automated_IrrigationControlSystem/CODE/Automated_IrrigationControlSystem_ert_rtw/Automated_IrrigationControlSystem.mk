###########################################################################
## Makefile generated for component 'Automated_IrrigationControlSystem'. 
## 
## Makefile     : Automated_IrrigationControlSystem.mk
## Generated on : Sun Feb 25 17:07:36 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Automated_IrrigationControlSystem.elf
...
PRODUCT_NAME              = Automated_IrrigationControlSystem
MAKEFILE                  = Automated_IrrigationControlSystem.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/eslam/Desktop/simulink_module_projects
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/eslam/DOCUME~1/MATLAB/R2023a/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Automated_IrrigationControlSystem.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=1000 -DMW_ARDUINO_MICROS -DARDUINO_NUM_SERIAL_PORTS=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=Automated_IrrigationControlSystem -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = Automated_IrrigationControlSystem.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/Automated_IrrigationControlSystem_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Automated_IrrigationControlSystem_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Automated_IrrigationControlSystem_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Automated_IrrigationControlSystem.o : $(START_DIR)/Automated_IrrigationControlSystem_ert_rtw/Automated_IrrigationControlSystem.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Automated_IrrigationControlSystem_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
